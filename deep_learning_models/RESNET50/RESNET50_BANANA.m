...
% ✅ Load Pre-trained ResNet50 network
net = resnet50;
featureLayer = 'fc1000';  % ✅ Feature extraction from fc1000 layer
...
for band = 1:23
    for i = 1:10  % Trials 1 to 10
        ...
        % === Extract Features from ResNet50 fc1000 Layer ===
    ...
    save(fullfile(outputFolder, ...
        sprintf('resnet50-fc1000-banana2-band-%02d-svm.mat', band)), ...
...
% === Resize Function for ResNet50 ===
function I = readFunctionTrainGrey(filename)
    I = imread(filename);
    I = imresize(I, [224 224]);  % ✅ Resize to fit ResNet50 input
